...
public class UserService {
    ...
    // autentifikavimas ar egzistuoja toks usser su tokiuais parametrais
    // autorizvimas - ką tas usser gali daryti,kokius veiksmus gali atlikti
    @POST
    @Path("/login")
...
//        return Response.ok().build(); // todo access
    ...
    // autentifikavimas ar egzistuoja toks usser su tokiais parametrais
    // autorizvimas - ką tas user gali daryti, kokius veiksmus gali atlikti
    @POST
    @Path("/logout")
